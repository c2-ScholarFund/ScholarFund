  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="flex justify-between items-center p-5 lg:w-7/12 sm:w-full absolute bottom-40 lg:left-96"
          style={{ backgroundColor: "#CF1A45", height: "6.5rem" }}
        >
          <div className="flex flex-col justify-center">
            <p className="lg: mt-10 sm: mt-0 text-white text-xl	">
              <b>It is urgent to move ahead together</b>
            </p>
            <p className="max-w-xl  text-white lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 lg:flex sm: hidden">
              <small>
                A small donation can make a big difference. Let’s go Together!
              </small>
            </p>
          </div>
          <div>
