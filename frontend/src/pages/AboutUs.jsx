    ...
    async function fetchData() {
      try {
        const response = await axios
          .get("http://localhost:3100/aboutus")
          .then((response) => {
            setaboutData(response?.data[0].about);
          });
      } catch (error) {
        console.error(error);
        return false;
    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            ScholarFund was founded with a clear mission - to fund students from
            around the world in their pursuit of scholarships.
          </p>
        </div>
        <div>
          <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
            At ScholarFund, our mission is simple yet powerful. We are dedicated
            to making education accessible to every student, regardless of their
            background or circumstances. Through our funding initiatives and
            resources, we strive to break down barriers and provide
          ...
          <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
            ...
            captivating and engaging content to our readers. We understand that
            the layout and presentation of information play a crucial role in
            capturing attention. That's why we strive to create a user-friendly
            and visually appealing platform that enhances the overall reading
            experience. Our commitment goes beyond just aesthetics. We believe
            in the inherent value of providing accurate and meaningful content.
            With a strong foundation rooted in our present charter, we uphold
