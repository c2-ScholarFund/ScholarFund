      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
              Welcome to ScholarFund - Empowering Students Worldwide!
            </h2>
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              ScholarFund was founded with a clear mission - to fund students
              from around the world in their pursuit of scholarships.
            </p>
          </div>
          <div>
            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              At ScholarFund, we are proud to have made a significant impact on
              the lives of students worldwide through our monthly enrichments.
            </p>
          </div>
          <div className="sm:block hidden">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Join our thriving community at ScholarFund, where over 4,000 users
              have found support and opportunities.Benefit from our funding
              resources
            </p>
          </div>
        </div>
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800">
              Our Mission: Empowering Education for All
            </h2>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
              At ScholarFund, our mission is simple yet powerful. We are
              dedicated to making education accessible to every student,
              regardless of their background or circumstances. Through our
              funding initiatives and resources, we strive to break down
              barriers and provide opportunities for students to pursue their
              dreams.
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
              At ScholarFund, we recognize the importance of delivering
              captivating and engaging content to our readers. We understand
              that the layout and presentation of information play a crucial
              role in capturing attention. That's why we strive to create a
              user-friendly and visually appealing platform that enhances the
              overall reading experience. Our commitment goes beyond just
              aesthetics. We believe in the inherent value of providing accurate
              and meaningful content. With a strong foundation rooted in our
              present charter, we uphold the principles of freedom and rights.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
              ...
              <div className="flex p-4 shadow-md">
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    Our dedicated team at ScholarFund is committed to empowering
                    students worldwide. With a shared vision and passion for
                    education.
                  </p>
                </div>
              </div>
              ...
              <div className="flex p-4 shadow-md">
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    ScholarFund is guided by a distinguished Board comprised of
                    accomplished individuals. Their expertise and leadership.
                  </p>
                </div>
              </div>
              ...
              <div className="flex p-4 shadow-md">
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    Our impactful work has been recognized by various media
                    outlets, highlighting our commitment to transforming lives
                    through scholarships and funding opportunities.
                  </p>
                </div>
              </div>
            </div>
