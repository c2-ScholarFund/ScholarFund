        ...
        <div className="xl:w-10/12 w-full px-8">
          <div className="bg-blue-800 py-12 flex flex-wrap items-center justify-center shadow">
            ...
            <div className="w-52 h-16 relative md:mt-0 mt-4">
              ...
              <div className="absolute w-full flex flex-col px-6 items-center justify-center inset-0 m-0">
                <p className="w-full text-sm font-large leading-4 text-indigo-800">Edit Your Information</p>
              </div>
            </div>
          </div>
                ...
                <div>
                  <div className="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                    <div className="md:w-64">
                      <label className="text-sm leading-none text-gray-800" htmlFor="firstName">
                        First name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="md:w-64 md:ml-12 md:mt-0 mt-4">
                      <label className="text-sm leading-none text-gray-800" htmlFor="lastName">
                        Last name
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="md:flex items-center lg:ml-24 mt-8">
                    <div className="md:w-64">
                      <label className="text-sm leading-none text-gray-800" htmlFor="emailAddress">
                        Email address
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="md:w-64 md:ml-12 md:mt-0 mt-4">
                      <label className="text-sm leading-none text-gray-800" htmlFor="username">
                        Username
                      </label>
                      <input
                        type="text"
