      ...
      <div className="relative grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="relative lg:col-span-5">
          ...
          <div className="absolute bottom-0 left-0 right-0">
            <div className="flex justify-between items-center p-5 lg:w-full sm:w-full  bg-gray-900">
              ...
              <div>
                <Link
                  to="Studants"
                  className="inline-flex bg-white items-center justify-center px-7 py-2 text-bold font-medium text-center text-red-600 border border-gray-300 rounded-sm hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800 transition-all duration-300"
                >
                  Donate Now
                </Link>
              </div>
